...
export interface ChatMemory {intent:"DISCOUNTS"|"MOVIES"|"MORE_MOVIES"|"MOVIE_DETAILS"|"SEATS"|"GREETING"|"OFF_TOPIC"|"CLARIFY";genre:string|null;maxDuration:number|null;date:string|null;people:number|null;budget:number|null;discountCode?:string|null;}
...
export default {chat:async(request:ChatRequest)=>await axios.post("/api/v1/assistant/chat",request,{timeout:60000}) as unknown as {data:ChatReply}};
